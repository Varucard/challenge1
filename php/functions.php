<?php
   ...
   * 
   * @param string $inputKey Valor a verificar
   * @param string[] $values Arreglo de Strings para verificar el valor ingresado
   * 
   * @return string|boolean Si cumple con los parametros devuelve el mismo convetido a Mayusculas. De lo contrario retorna 'false'
   */
