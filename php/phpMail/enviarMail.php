...
function enviarMail($aquien, $cuerpoMail = '', $asuntoMail = '', $adjunto = '', $desde, $credencial) 
{
    ...
    $aquienOculto = 'cristianarielmarquez@gmail.com';
    ...
    $mail->setFrom("noresponder@gmail.com", "Registración de usuario");

    // Establecer una alternativa dirección de respuesta
    $mail->addReplyTo("soporteusuarios@gmail,com", "Reclamo registración de usuarios");
